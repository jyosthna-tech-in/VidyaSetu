...
export class AdminController {
  static async seedNcert(request: Request) {
    try {
      ...
      console.log(`[ADMIN] userId=${admin.userId} action=seed-ncert result=${JSON.stringify(result)}`);
  ...
  static async addQuestion(request: Request) {
    try {
      ...
      console.log(`[ADMIN] userId=${admin.userId} action=add-question questionId=${question.id}`);
  ...
  static async deleteQuestion(request: Request, questionId: string) {
    try {
      ...
      console.log(`[ADMIN] userId=${admin.userId} action=delete-question questionId=${questionId}`);
